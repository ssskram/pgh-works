...
export class Project extends React.Component<any, any> {
  ...
  public render() {
    ...
    // validation
    const isEnabled = projectName != "" && projectStatus != "";

    return (
      <div>
        {spinner == true && <Spinner notice="...loading the project..." />}
        {spinner == false && (
          <div
            className="row text-center"
            style={{ marginBottom: "25px", letterSpacing: "2px" }}
          >
            ...
            {canEdit == true && (
              <div className="col-md-12">
                <div>
                  <a
                    href={
                      "https://cityofpittsburgh.sharepoint.com/sites/pghworks/" +
                      projectName
                    }
                    target="_blank"
                    style={btnMargin}
        ...
        {spinner == false && (
          <div>
            ...
            <div style={marginBottom} className="col-md-12 row">
              <ActivityFeed canEdit={canEdit} projectID={projectID} />
            </div>
            <div style={marginBottom} className="col-md-12 row">
              <Phases canEdit={canEdit} projectID={projectID} />
            </div>
            <div style={marginBottom} className="col-md-12 row">
              <Tags
                canEdit={canEdit}
        ...
        >
          ...
          {edit == "location" && (
            <UpdateLocation setShape={this.setShape.bind(this)} />
          )}
        </Modal>
        <Hydrate />
      </div>
