...
export class ActivityFeed extends React.Component<any, any> {
  constructor(props) {
    ...
    subscribeToActivity((err, activity) =>
      this.props.receiveActivity(activity)
    );
  }
  ...
  componentWillReceiveProps(nextProps) {
    ...
    if (nextProps.personnel.length > 0 && nextProps.user) {
      const user = nextProps.personnel.find(
        person => person.email == nextProps.user
      );
      this.setState({
        user: user.title
      });
  ...
  public render() {
    const user = this.props.personnel.find(
      person => person.email == this.props.user
    );
                  ...
                  return (
                    ...
                    >
                      <div className="col-md-12">
                        <div
                          style={otherActivity}
                          className="speech-bubble-right pull-right"
                        >
                          ...
                          <span style={smallFont}>
                            <span
                              style={{ fontSize: ".9em" }}
                              className="glyphicon glyphicon-user nav-glyphicon"
                            />
                            {item.user}
                          </span>
                          <br />
                      ...
                      <div className="col-md-12">
                        <div className="pull-right">
                          <span style={{ fontSize: ".85em", color: "#fff" }}>
                            {item.date}
                          </span>
                        </div>
                      </div>
                  ...
                  return (
                    ...
                    >
                      <div className="col-md-12">
                        <div
                          style={myActivity}
                          className="speech-bubble-left pull-left"
                        >
                          <span style={{ margin: "10px" }}>
                            {item.activity}
                          </span>
        ...
        <div style={{ paddingLeft: "5px" }}>
          <input
            ...
            placeholder={
              this.props.canEdit
                ? "New message"
                : "You must be a project member to contribute"
            }
          />
          <button
            disabled={!isEnabled}
            className="chatButton btn"
