...
export class ProjectDefinition extends React.Component<any, any> {
  ...
  post(projectDesc) {
    this.setState(
      ...
      function(this) {
        if (
          this.state.shapeType == "new" &&
          this.state.assetTypeCheck == false
        ) {
          this.setState({
            modalIsOpen: true
          });
  ...
  public render() {
    const { step, redirect, projectID, shape, modalIsOpen } = this.state;
          ...
          <b>
            {step == 1 && (
              <span className="pull-right">
                <span className="glyphicon glyphicon-map-marker nav-glyphicon hidden-xs" />
                Location
              </span>
            )}
            {step == 2 && (
              <span className="pull-right">
                <span className="glyphicon glyphicon-info-sign nav-glyphicon hidden-xs" />
                Description
              </span>
            )}
          </b>
