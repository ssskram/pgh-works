...
export class Home extends React.Component<any, any> {
  ...
  public render() {
    const { onFilter, redirect, projectID, projects } = this.state;
    ...
    return (
      <div>
        ...
        <Helmet>
          <style>
            {
              ".col-sm-9 { width: 100%; padding: 0; } .container-fluid { padding: 0; } body { padding: 0; overflow: hidden; } "
            }
          </style>
        </Helmet>
        <Map
          projects={projects}
          receiveProject={this.receiveProject.bind(this)}
        />
