...
export class MyProjects extends React.Component<any, any> {
  ...
  public render() {
    const { onFilter, projects, currentPage } = this.state;
                ...
                <div className="panel-body text-center">
                  <div className="col-md-12">
                    ...
                    {project.projectLocation && (
                      <h5 style={linePadding}>
                        <i>{project.projectLocation}</i>
                      </h5>
                    )}
                    {project.projectDescription && (
                      <h4 style={linePadding}>
                        "{project.projectDescription}"
                      </h4>
                    )}
                    ...
                    <h5 style={linePadding}>
                      Status: <b>{project.projectStatus}</b>
                    </h5>
                    <h5 style={linePadding}>
                      PM: <b>{project.projectManager}</b>
                    </h5>
                  </div>
                </div>
              </Link>
        ...
        {this.props.projects.length > 0 &&
          ...
          onFilter == false && (
            ...
            >
              ...
              >
                <h3 style={emptyNotice}>
                  <i>You don't have any projects</i>
                </h3>
              </div>
            </div>
          )}
