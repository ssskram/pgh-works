...
export class PhaseTimeline extends React.Component<any, any> {
  public render() {
    ...
    // add subphases
    this.props.subphases
      .filter(sp => sp.phaseID == this.props.phase.phaseID)
      .forEach(s => {
        const sb = {
          id: counter + 1,
    ...
    this.props.milestones
      .filter(ms => ms.phaseID == this.props.phase.phaseID)
      .forEach((m, i) => {
        let mi;
        ...
        >
          ...
          <span
            style={{
              ...
              borderTop: ".5px solid #383838",
              borderBottom: ".5px solid #383838",
              borderRight: ".5px solid #383838"
            }}
          >
            Milestone
          </span>
        </div>
        {this.props.phase && <TL items={items} />}
      </div>
    );
  }
}
